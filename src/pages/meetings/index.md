...
## 2026-10-05: Logging and Observability Guide Review (Upcoming)

*Note: the group is skipping 2026-09-07  and 2026-09-21 due to lack of availability of members.*
...
of time spent reading through and editing.

## 2026-08-24: Logging and Observability Guide Review

*The sessions on 2026-07-27 and 2026-08-10 were skipped due to lack of availability of members.*

The group met and continued reviewing the L&O guide. We switched from thorough review to a
higher-level read with TODOs to mark where improvements needed to be made. One member can then make
the changes between sessions.

## 2026-07-13: Logging and Observability Guide Review

The group met and started working through the first draft of the Logging and
Observability guide, initially generated by AI. This was built from the skeleton
of the guide from the prior session and transcripts from all relevant meeting
recordings to generate an initial guide. The group started editing this guide
and plan to continue editing in future sessions.

Please note: as this session contained a lot of reading and editing, the group
did not record the session.

Also note that the session on 2026-06-29 has been skipped due to lack of
availability from members.

## 2026-06-15: Logging and Observability Discussion

The group has been discussing Logging and Observability tips and best practices
over the course of several months. In this session, the group came up with a
skeleton for a Logging and Observability Guide that could be filled out in
future sessions. Once the guide is written, previous guest speakers will be
invited to review it before it's published.

If you'd like to see the meeting, is it available on YouTube:

<iframe width="560" height="315" src="https://www.youtube.com/embed/Y87uzCrsNik?si=luAa9mXAWzX7X5xa" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
